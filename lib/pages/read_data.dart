...
class _ReadDataState extends State<ReadData> {
  ...
  searchUser(String name) async {
    ...
    cafe = "${querySnapshot.docs[0]["Cafe"]}";
    location = "${querySnapshot.docs[0]["Location"]}";
    rate = "${querySnapshot.docs[0]["Rate"]}";
      ...
      body: Container(
        child: Column(
          ...
          children: [
            ...
            GestureDetector(
              onTap: () async {
                await DatabaseMethods().UpdateUserData("Malang", id!);
                searchUser(textcontroller.text);
